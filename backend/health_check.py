...
def main():
    ...
    try:
        ...
        print("❌ Cannot import settings. Make sure you're in the backend directory.")
        sys.exit(1)
    ...
    print("=" * 40)
    if all_healthy:
        print("🎉 All services are healthy! Ready to start the backend server.")
        print("Run: python run_server.py")
    else:
        print("❌ Some services are not available. Please fix the issues above.")
        sys.exit(1)
